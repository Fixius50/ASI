...
public class RenombrarImagenes {
    ...
    public static void main(String[] args) {
        ...
        String rutaCarpeta = "comparacion_modelos/media";
        ...
        try {
            ...
            for (Path archivoOriginal : archivosJpg) {
                ...
                // Evitar sobreescribir si el archivo ya se llama "1.jpg" (por si corres el
                // script 2 veces)
                if (archivoOriginal.getFileName().toString().equals(nuevoNombreArchivo)) {
                    System.out
                            .println("El archivo " + nuevoNombreArchivo + " ya tiene el nombre correcto. Saltando...");
                    contador++;
                    continue;
                }
